...
router.get('/deck/:id/exercise', [DecksController, 'exercise']).as('deck.exercise')
...
router.delete('/deck/:deckId/card/:id/destroy', [CardsController, 'destroy']).as('card.destroy')